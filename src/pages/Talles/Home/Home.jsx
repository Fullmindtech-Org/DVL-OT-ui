...
import { guardarTalle } from "../../../lib/actions";
...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchAndLogTotalPages() {
      const data = await fetchTalles(limit, page);
  ...
  return (
    <div className="w-full">
      <div className="flex w-full items-center justify-between">
        <h2 className="text-2xl text-black">Talles</h2>
      </div>
      <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
        ...
        >
          <span className="hidden md:block">Crear Talle</span>
