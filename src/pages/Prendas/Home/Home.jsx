...
import { TablaPrendas } from "../../../components/Tables";
import { fetchPrendas } from "../../../lib/data";
import Pagination from "../../../components/Pagination";
import Swal from "sweetalert2";
import { guardarPrenda } from "../../../lib/actions";
...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchAndLogTotalPages() {
      const data = await fetchPrendas(limit, page);
